        ...
        <form action="admin.php?page=onwebchat_settings" method="post">
            ...
            if($isConnected != true) {
                ...
                <div class="new-account-link">
                    Create your account with onWebChat live chat service if you haven't yet, by clicking <a href="https://www.onwebchat.com/signup.php" target="_blank">here</a>
                </div>

                <?php

                    $html = '<input class="button button-primary" style="margin-left: 230px;" type="submit" value="Activate"/>';
                    echo $html;
            }
            ...
            // 2nd Page
                ...
                <div id="help">
                    <span>Add multiple pages by separating them with a space. Feel free to include either a section of the page or the entire URL. e.g. &nbsp; index price contact.php blog/</span>
                </div>
                ...
                <div class="new-account-link">Click <a target="_blank" href="https://www.onwebchat.com/login.php">here</a> to access the onWebChat Operator Console  </div>
...
function onwebchat_login_error($contition = false) {
    ...
    if($contition) {
        ...
        <div class="error">
            <p><strong>Invalid Credentials!</strong> Ensure you enter the correct email and password, <strong>OR</strong> provide a valid Chat ID</p>
        </div>
        <?php
    }
    else {
